...
# point
# - インスタンスを生成する流れを定義するフレームワーク側とそれを利用する側に分かれている
# - そうすることで、具体的なクラス名はサブクラスで決めることができ、別の製品を作る場合にもフレームワークを利用して簡単にインスタンスを生成することができる
...
# https://www.macky-studio.com/entry/2019/05/22/175041
